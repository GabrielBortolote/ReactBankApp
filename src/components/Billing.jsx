...
const Billing = () => (
  <section id='product' className={layout.sectionReverse}>
    <div className={layout.sectionImgReverse}>
      ...
      <div className="rounded-full absolute z-[3] -left-1/2 top-0 w-[50%] h-[50%] pink__gradient"/>
    ...
    <div className={layout.sectionInfo}>
      <h2 className={styles.heading2}>Easily control your <br className='sm:block hidden' /> billing & invoicing.</h2>
        ...
        <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
          <img src={apple} alt="apple_store_icon" className='w-[128px] h-[42px] object-contain mr-5 cursor-pointer'/>

          <img src={google} alt="google_play_icon" className='w-[128px] h-[42px] object-contain cursor-pointer'/>
        </div>
    </div>
  </section>
)
