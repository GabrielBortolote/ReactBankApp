...
const Hero = () => {
  return (
    ...
    >
      ...
      <div classNames={`flex flex-1 ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={robot} alt="billing" className='w-[100%] h-[100%] relative z-[5]'/>

        <div className='absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient' />
        
        <div className='absolute z-[1] w-[80%] h-[80%] full-rounded bottom-40 white__gradient' />

        <div className='absolute z-[0] w-[50%] h-[50%] full-rounded right-20 bottom-20 blue__gradient' />
      </div>
